...
#_admin.php:107
$GLOBALS['__l10n']['Show Dotclear\'s latest versions on dashboard.'] = 'Montrer les dernières versions de Dotclear sur le tableau de bord';

#_admin.php:167
$GLOBALS['__l10n']['<li><a href="%u" title="Download Dotclear %v">%r</a> : %v</li>'] = '<li><a href="%u" title="Télécharger Dotclear %v">%r</a> : %v</li>';

#_admin.php:208
#debug.php:104
#debug.php:114
$GLOBALS['__l10n']['Dotclear\'s latest versions'] = 'Dernières versions de Dotclear';

#debug.php:39
$GLOBALS['__l10n']['<li><a href="%u" title="Download Dotclear version %v">%r</a> : %v</li>'] = '<li><a href="%u" title="Télécharger Dotclear %v">%r</a> : %v</li>';
