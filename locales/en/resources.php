 ...
 * 
 * help resources loader
 */
/* dcLatestVersionsLight/locales/en/resources.php */

if (!isset($__resources['help']['dcLatestVersionsLight'])) {
    $__resources['help']['dcLatestVersionsLight'] = dirname(__FILE__) . '/help/help.html';
}